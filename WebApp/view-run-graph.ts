...
// const cumulativeInfectionsData: Partial<Plotly.PlotData> = {
//   x: [],
//   y: [],
...
const infectedData: Partial<Plotly.PlotData> = {
  x: [],
  y: [],
  name: 'Infected',
  type: 'scatter',
...
const susceptibleData: Partial<Plotly.PlotData> = {
  x: [],
  y: [],
  name: 'Susceptible',
  type: 'scatter',
...
const recoveredData: Partial<Plotly.PlotData> = {
  x: [],
  y: [],
  name: 'Recovered',
  type: 'scatter',
...
// const deadData: Partial<Plotly.PlotData> = {
//   x: [],
//   y: [],
//   name: 'Dead',
//   type: 'scatter',
...
// const maxHealthCare: Partial<Plotly.PlotData> = {
//   x: [],
//   y: [],
...
const updateGraph = (newData: GraphData) => {
	...
	recoveredData.y[tick] = recovered
